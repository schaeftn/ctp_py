...
class FclMotionValidator(ob.MotionValidator):
    ...
    def motionIsValidForSceneObject(self, t_start,t_end, obj):
        ...
        result2 = fcl.ContinuousCollisionResult()
